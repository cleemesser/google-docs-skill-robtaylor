...
```bash
gsuite docs read 1abc-xyz-document-123
```
...
```bash
gsuite docs structure 1abc-xyz-document-123
```
...
gsuite docs structure new_doc_abc
...
gsuite docs read proposal_doc_123 > current_state.json
...
create_from_template() {
  ...
  }' | gsuite docs create | jq -r '.document_id')
...
gsuite docs read doc_abc_123

# Step 2: Get structure for reference points
gsuite docs structure doc_abc_123
...
gsuite docs read doc_abc_123 > backup.json
...
gsuite docs read doc_abc > state.json
gsuite docs structure doc_abc > structure.json

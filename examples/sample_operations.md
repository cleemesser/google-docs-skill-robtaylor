...
```bash
~/.claude/skills/google-docs/scripts/docs_manager.py read 1abc-xyz-document-123
```
...
```bash
~/.claude/skills/google-docs/scripts/docs_manager.py structure 1abc-xyz-document-123
```
...
echo '{
  ...
  "index": 1
}' | ~/.claude/skills/google-docs/scripts/docs_manager.py insert
```
...
echo '{
  ...
  "end_index": 22,
  "bold": true
}' | ~/.claude/skills/google-docs/scripts/docs_manager.py format
```
...
echo '{
  "document_id": "1abc-xyz-document-123",
  "index": 500
}' | ~/.claude/skills/google-docs/scripts/docs_manager.py page-break
```
...
echo '{
  ...
  "start_index": 1000,
  "end_index": 1500
}' | ~/.claude/skills/google-docs/scripts/docs_manager.py delete
```
...
~/.claude/skills/google-docs/scripts/docs_manager.py structure new_doc_abc
...
~/.claude/skills/google-docs/scripts/docs_manager.py read proposal_doc_123 > current_state.json
...
create_from_template() {
  ...
  }' | ~/.claude/skills/google-docs/scripts/docs_manager.py create | jq -r '.document_id')
...
~/.claude/skills/google-drive/scripts/drive_manager.py --operation move \
  --file-id "$doc_id" \
  --parent-id "team_folder_id_xyz"

# Step 5: Share with team
~/.claude/skills/google-drive/scripts/drive_manager.py --operation share \
  --file-id "$doc_id" \
  --email team@company.com \
  --role writer

# Step 6: Generate PDF for archive
~/.claude/skills/google-drive/scripts/drive_manager.py --operation export \
  --file-id "$doc_id" \
...
~/.claude/skills/google-docs/scripts/docs_manager.py read doc_abc_123

# Step 2: Get structure for reference points
~/.claude/skills/google-docs/scripts/docs_manager.py structure doc_abc_123
...
~/.claude/skills/google-docs/scripts/docs_manager.py read doc_abc_123 > backup.json
...
~/.claude/skills/google-docs/scripts/docs_manager.py read doc_abc
# ... format operation ...
~/.claude/skills/google-docs/scripts/docs_manager.py read doc_abc
...
~/.claude/skills/google-docs/scripts/docs_manager.py read doc_abc > state.json
~/.claude/skills/google-docs/scripts/docs_manager.py structure doc_abc > structure.json
...
~/.claude/skills/google-docs/scripts/docs_manager.py structure doc_abc
